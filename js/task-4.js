    ...
    function getShippingCost(country) {
        ...
        switch (country.toLowerCase()) {
            ...
            case 'jamaica':
                ...
                break;
            default:
                return `Sorry, there is no delivery to your country ${cost}`;
        }

        const shipping = `Shipping to ${country} will cost ${cost} credits`;
        return shipping;

    }

    console.log(getShippingCost("Australia")); // "Shipping to Australia will cost170 credits" 
    console.log(getShippingCost("Germany")); // "Sorry, there is nodelivery to your country" 
    console.log(getShippingCost("China")); // "Shipping toChina will cost 100 credits" 
    console.log(getShippingCost("Chile")); // "Shippingto Chile will cost 250 credits" 
